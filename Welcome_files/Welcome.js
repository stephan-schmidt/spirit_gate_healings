IMpreload('Welcome_files', 'shapeimage_2', '0');
IMpreload('Welcome_files', 'shapeimage_2', '1');
...
function onPageLoad()
{
    ...
    fixupIEPNG("shapeimage_2_link_0", "Welcome_files/transparent.gif");
    fixupIEPNG("shapeimage_2_link_1", "Welcome_files/transparent.gif");
    fixupIEPNG("shapeimage_2", "Welcome_files/transparent.gif");
    fixupIEPNG("id5", "Welcome_files/transparent.gif");
    fixupIEPNG("id12", "Welcome_files/transparent.gif");
    return true;
}
